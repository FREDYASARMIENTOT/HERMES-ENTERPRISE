...
Describe 'Command Names and Aliases' -Tag 'Commands', 'RC62' {
    ...
    It 'Should have all expected aliases mapping to correct commands' {
        ...
        foreach ($alias in $expectedAliases.Keys) {
            $aliases[$alias] | Should -Not -BeNullOrEmpty
...
Describe 'Command Help and Documentation' -Tag 'Help', 'RC62' {
    ...
    It 'Commands with parameters should show parameter help' {
        ...
        foreach ($cmd in $paramCmds) {
            ...
            $help.parameters.parameter | Should -Not -BeNullOrEmpty -Because "$($cmd.Name) should have parameter help"
        }
    }
}
...
Describe 'Crear-HermesProyecto' -Tag 'Project', 'RC62' {
    ...
    It 'Should have optional -TipoEntorno with ValidateSet(venv,conda)' {
        ...
        $att.ValidValues | Should -Contain 'venv'
        $att.ValidValues | Should -Contain 'conda'
    }
...
Describe 'Get-HermesProyecto' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Get-HermesProyecto -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Start-HermesProject' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Start-HermesProject -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Abrir-HermesProyecto' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Abrir-HermesProyecto -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Publicar-HermesProyecto' -Tag 'Project', 'GitHub', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Publicar-HermesProyecto -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Cerrar-HermesProyecto' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Cerrar-HermesProyecto -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Eliminar-HermesProyecto' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Eliminar-HermesProyecto -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Get-HermesProyectos' -Tag 'Project', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Get-HermesProyectos -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Test-HermesPython' -Tag 'Utility', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Test-HermesPython -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'New-HermesDocumentacion' -Tag 'Utility', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command New-HermesDocumentacion -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'New-HermesCommit' -Tag 'Git', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command New-HermesCommit -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Environment Commands' -Tag 'Environment', 'RC62' {
    ...
    It 'New-HermesVenv should exist' {
        Get-Command New-HermesVenv -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Enter-HermesVenv should exist' {
        Get-Command Enter-HermesVenv -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Remove-HermesVenv should exist' {
        Get-Command Remove-HermesVenv -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }

    It 'New-HermesConda should exist' {
        Get-Command New-HermesConda -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Enter-HermesConda should exist' {
        Get-Command Enter-HermesConda -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Remove-HermesConda should exist' {
        Get-Command Remove-HermesConda -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Workspace Commands' -Tag 'Workspace', 'RC62' {
    ...
    It 'New-HermesWorkspace should exist' {
        Get-Command New-HermesWorkspace -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Open-HermesWorkspace should exist' {
        Get-Command Open-HermesWorkspace -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
    ...
    It 'Get-HermesWorkspace should exist' {
        Get-Command Get-HermesWorkspace -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
}

Describe 'Install-ProjectFromFactory' -Tag 'Utility', 'RC62' {
    It 'Should exist and be a Function' {
        Get-Command Install-ProjectFromFactory -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
    }
...
Describe 'Error Handling' -Tag 'ErrorHandling', 'RC62' {
    It 'Should handle empty project name gracefully' {
        $result = Crear-HermesProyecto -NombreProyecto "" 2>$null
        $result | Should -Be $null
    }
