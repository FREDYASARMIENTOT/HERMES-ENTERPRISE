...
| Campo | Valor |
|---|---|
| NombreDocumento | Plugin Discovery |
...
Documentar el descubrimiento automático de plugins por manifiestos plugin.json.

## Alcance

Búsqueda recursiva bajo plugins/ y creación de objetos PluginDescubierto.

## Contenido inicial

El discovery se implementa en motor/discovery/PluginDiscovery.ps1.
