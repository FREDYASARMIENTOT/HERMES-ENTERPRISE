...
| Campo | Valor |
|---|---|
| NombreDocumento | Module Registry |
...
Documentar el registro de módulos desacoplados del Kernel Enterprise.

## Alcance

Registro idempotente de nombre, versión, ruta, capacidades y estado de módulos.

## Contenido inicial

El registro se implementa en motor/registro/ModuleRegistry.ps1.
