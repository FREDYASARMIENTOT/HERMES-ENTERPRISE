...
| Campo | Valor |
|---|---|
| NombreDocumento | Configuration Manager |
...
Documentar la administración centralizada de configuración del Kernel Enterprise.

## Alcance

Configuración JSON local idempotente, sin secretos y preparada para evolución futura.

## Contenido inicial

El administrador se implementa en motor/configuracion/ConfigurationManager.ps1.
