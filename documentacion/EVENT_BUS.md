...
Documentar la comunicación desacoplada por eventos dentro del Kernel Enterprise.

## Alcance

Suscripción y publicación de eventos en memoria para infraestructura inicial.

## Contenido inicial

El bus de eventos se implementa en motor/eventos/EventBus.ps1.
