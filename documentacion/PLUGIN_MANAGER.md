...
| Campo | Valor |
|---|---|
| NombreDocumento | Plugin Manager |
...
Documentar el administrador que descubre, valida, ordena, carga e inicializa plugins.

## Alcance

Orquesta discovery, dependency graph, version validator, contracts, lifecycle y provider registry.

## Contenido inicial

El administrador se implementa en motor/plugins/PluginManager.ps1 y se integra al Kernel.
