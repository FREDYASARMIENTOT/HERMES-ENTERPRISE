...
| Campo | Valor |
|---|---|
| NombreDocumento | Plugin Lifecycle |
...
Documentar el ciclo de vida estándar de plugins Enterprise.

## Alcance

Install, Initialize, Start, Pause, Resume, Stop y Dispose.

## Contenido inicial

El gestor se implementa en motor/lifecycle/LifecycleManager.ps1.

## Referencias cruzadas

- Plugin Manager: documentacion/PLUGIN_MANAGER.md
- HelloPlugin: plugins/HelloPlugin/HelloPlugin.ps1
