...
| Campo | Valor |
|---|---|
| NombreDocumento | Runtime Enterprise |
...
Documentar el ciclo de vida del Runtime del Kernel Enterprise.

## Alcance

Estados Creado, EnEjecucion y Detenido, con publicación de eventos de ciclo de vida.

## Contenido inicial

El Runtime se implementa en motor/runtime/Runtime.ps1 y se orquesta desde el Kernel.
